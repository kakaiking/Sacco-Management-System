...
import { FiEye, FiEdit3, FiTrash2, FiCheckCircle, FiClock, FiXCircle } from "react-icons/fi";
      ...
      <main className="dashboard__content">
        ...
        <section className="card" style={{ padding: 12 }}>
          <div className="tableToolbar">
            ...
            {canAdd(PERMISSIONS.CHARGES_MANAGEMENT) ? (
              <button 
                className="pill" 
              ...
              <button 
                className="pill" 
                onClick={() => showMessage("Your role lacks permission to add charges", "error")}
                style={{
                ...
                title="Add Charge - No Permission"
                disabled
              >
                <FaPlus />
                Add Charge
