        ...
        <form className="card" onSubmit={save} style={{ display: "grid", gap: 12, padding: 16 }}>
          ...
          {activeTab === "personal" && (
            ...
            <div className="grid2">
                ...
                <label>Gender
                  <select className="inputz" value={form.gender || ""} onChange={e => setForm({ ...form, gender: e.target.value })} required disabled={!isCreate && !isEdit}>
                ...
                <label>Identification Type
                  <select className="inputz" value={form.identificationType || ""} onChange={e => setForm({ ...form, identificationType: e.target.value })} disabled={!isCreate && !isEdit}>
                ...
                <label>Category
                  <select className="inputz" value={form.category || ""} onChange={e => setForm({ ...form, category: e.target.value })} disabled={!isCreate && !isEdit}>
                    <option value="">Select Category</option>
                    <option>Individual Member</option>
                    <option>Individual Non-member</option>
          ...
          {activeTab === "nextOfKin" && (
            <div>
              <div className="grid2" style={{ marginBottom: "20px" }}>
                ...
                <label>Relation Type
                  <select className="inputz" value={nextOfKinForm.relationType || ""} onChange={e => setNextOfKinForm({ ...nextOfKinForm, relationType: e.target.value })} disabled={!isCreate && !isEdit}>
                ...
                <label>Gender
                  <select className="inputz" value={nextOfKinForm.gender || ""} onChange={e => setNextOfKinForm({ ...nextOfKinForm, gender: e.target.value })} disabled={!isCreate && !isEdit}>
                    <option value="">Select Gender</option>
                    <option>Male</option>
                    <option>Female</option>
                  </select>
